...
class WEBOS_EXPORT WebOSMainDelegate {
 public:
  // NOTE(neva): BasicStartupComplete is not pure virtual because it is
  // implemented in OSE WAM only. Will need to make it pure virtual once
  // WAM on other platforms will implement it too.
