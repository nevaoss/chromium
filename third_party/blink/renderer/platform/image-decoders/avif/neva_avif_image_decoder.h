...
class PLATFORM_EXPORT NevaAVIFImageDecoder final : public ImageDecoder {
 public:
  NevaAVIFImageDecoder(AlphaOption,
                       HighBitDepthDecodingOption,
                       ColorBehavior,
                       cc::AuxImage,
                       wtf_size_t max_decoded_bytes,
                       AnimationOption);
  NevaAVIFImageDecoder(const NevaAVIFImageDecoder&) = delete;
  NevaAVIFImageDecoder& operator=(const NevaAVIFImageDecoder&) = delete;
  ~NevaAVIFImageDecoder() override;
