...
class EntityType final {
 public:
  ...
  // If the flag is set to `true`, `import_constraints` and `strike_keys`
  // must be empty - this is validated during schema transpilation.
  // This implies the entity cannot be imported or updated from
