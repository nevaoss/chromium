...
// Disable Canvas OOP (Out Of Process) Rasterization
const char kDisableSupportOopRasterization[] =
    "disable-support-oop-rasterization";
...
// The kSkiaFontCacheLimitMb already exists, but this flag is useful for
// reducing memory usage when setting under 1MB.
const char kSkiaFontCacheLimitKb[] = "skia-font-cache-limit-kb";
