...
class ShellWindow : public views::NativeEventDelegate,
 ...
 public:
  ...
  PageView* GetMainPageView() const;
  PageContents* GetMainPageContents() const;
  std::unique_ptr<PageView> SetMainPageView(
      std::unique_ptr<PageView> page_view);
  std::unique_ptr<PageView> RemoveMainPageView();
