...
ContentSetting
AppRuntimeAutomaticFullscreenPermissionContext::GetContentSettingStatusInternal(
  ...
  return AutomaticFullscreenPermissionContext::GetContentSettingStatusInternal(
