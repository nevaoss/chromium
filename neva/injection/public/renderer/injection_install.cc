...
#if defined(ENABLE_LAUNCHPOINT_WEBAPI)
...
#endif
#if defined(ENABLE_LAUNCHPOINT_WEBAPI)
  if (name == webapi::kLaunchPoint) {
    api->install_func = LaunchPointWebAPI::Install;
    api->uninstall_func = LaunchPointWebAPI::Uninstall;
    return true;
  }
#endif
#if defined(ENABLE_MEMORYMANAGER_WEBAPI)
