...
void BrowserShellLogin::Trace(cppgc::Visitor* visitor) const {
  visitor->Trace(auth_info_);
  gin::Wrappable<BrowserShellLogin>::Trace(visitor);
}
...
const gin::WrapperInfo* BrowserShellLogin::wrapper_info() const {
  return &kWrapperInfo;
}
