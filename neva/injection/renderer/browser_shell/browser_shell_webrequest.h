...
class BrowserShellWebRequest final
    : public gin::Wrappable<BrowserShellWebRequest>,
      public browser_shell::mojom::WebRequestClient {
 public:
  static constexpr gin::WrapperInfo kWrapperInfo = {
      {gin::kEmbedderNativeGin},
      gin::kBrowserShellWebRequest};
  ...
  cppgc::Persistent<gin::WeakCell<BrowserShellWebRequest>> GetAsWeak() {
 ...
 private:
  ...
  v8::TracedReference<v8::Function> on_before_request_listener_;
  ...
  gin::WeakCellFactory<BrowserShellWebRequest> weak_factory_{this};
};
