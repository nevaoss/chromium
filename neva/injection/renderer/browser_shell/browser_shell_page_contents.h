...
class BrowserShellPageContents final
 ...
 public:
  ...
  cppgc::Persistent<gin::WeakCell<BrowserShellPageContents>> GetAsWeak() {
  ...
  void ActivateContents() override;
  ...
  void OnCapturingMediaStreamChanged(bool is_capturing_media_stream) override;
  ...
  void OnPageContentsActivated() override;
  void OnPageContentsDeactivated(bool by_page_discarder) override;
  void OnRendererUnresponsive() override;
  void OnRendererResponsive() override;
  void OnPermissionRequest(const std::string& permission, uint64_t id) override;
  void OnTouchStartEvent() override;
 ...
 private:
  ...
  void OnCaptureVisibleRegionReply(v8::Global<v8::Function> callback,
  ...
  mojo::AssociatedReceiver<browser_shell::mojom::PageContentsClient>
      receiver_{this};
  gin::WeakCellFactory<BrowserShellPageContents> weak_factory_{this};
};
