...
class BrowserShellPageView final
 ...
 public:
  ...
  static char kHasParentWindowMethodName[];
  ...
  cppgc::Persistent<gin::WeakCell<BrowserShellPageView>> GetAsWeak() {
  ...
  void Setup(uint64_t id, browser_shell::mojom::RectPtr bounds);
 ...
 private:
  ...
  bool HasParentView() const { return IsAttached(); }
  ...
  mojo::AssociatedReceiver<browser_shell::mojom::PageViewClient>
      receiver_{this};
  v8::TracedReference<v8::Object> page_contents_object_;
  std::map<uint64_t, v8::TracedReference<v8::Object>> child_view_objects_;
  gin::WeakCellFactory<BrowserShellPageView> weak_factory_{this};
};
