...
class SampleInjection final : public gin::Wrappable<SampleInjection>,
                              public pal::mojom::SampleListener {
 public:
  static constexpr gin::WrapperInfo kWrapperInfo = {{gin::kEmbedderNativeGin},
                                                    gin::kSampleInjection};
  ...
  cppgc::Persistent<gin::WeakCell<SampleInjection>> GetAsWeak() {
 ...
 private:
  ...
  void OnProcessDataRespond(v8::Global<v8::Function> callback,
                            std::string data,
                            bool result);
  ...
  gin::WeakCellFactory<SampleInjection> weak_factory_{this};
};
