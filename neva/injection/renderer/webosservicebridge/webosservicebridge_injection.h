...
class WebOSServiceBridgeInjection final
 ...
 public:
  ...
  cppgc::Persistent<gin::WeakCell<WebOSServiceBridgeInjection>> GetAsWeak() {
 ...
 private:
  ...
  gin::WeakCellFactory<WebOSServiceBridgeInjection> weak_factory_{this};
};
