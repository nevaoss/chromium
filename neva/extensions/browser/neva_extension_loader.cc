...
NevaExtensionLoader::NevaExtensionLoader(
  ...
  extension_registrar_->Init(this, /*extensions_enabled=*/true,
                             base::CommandLine::ForCurrentProcess(),
                             browser_context_->GetPath().AppendASCII(
                                 extensions::kInstallDirectoryName),
                             browser_context_->GetPath().AppendASCII(
...
void NevaExtensionLoader::OnAddNewOrUpdatedExtension(
    const extensions::Extension* extension) {}
...
void NevaExtensionLoader::DoLoadExtensionForReload(
...
void NevaExtensionLoader::ShowExtensionDisabledError(
    const extensions::Extension* extension,
...
void NevaExtensionLoader::GrantActivePermissions(
    const extensions::Extension* extension) {}

void NevaExtensionLoader::UpdateExternalExtensionAlert() {}

void NevaExtensionLoader::OnExtensionInstalled(
    const extensions::Extension* extension,
