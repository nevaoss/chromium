...
void delete_output(wl_output* output) {
  // TODO(neva): webOS/Starfish don't support WL_OUTPUT_RELEASE_SINCE_VERSION
  // and wl_output_release. webOS/OSE supports it. See the
...
IMPLEMENT_WAYLAND_OBJECT_TRAITS(wl_fixes)
