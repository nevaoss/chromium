...
class WaylandExtensions {
 public:
  ...
  // Creates and returns xdg toplevel wrapper object.
  virtual std::unique_ptr<XdgToplevel> CreateXdgToplevel(
  ...
  // Creates and returns xdg popup wrapper object.
  virtual std::unique_ptr<XdgPopup> CreateXdgPopup(WaylandWindow* window) = 0;
